...
@endpush
@section('content')
    <x-breadcrumb pagetitle="UI Elements" title="Notifications" />
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="mb-3 my-4">
                                ...
                                <div class="form-check mb-2">
                                    <input type="checkbox" class="form-check-input input-mini" id="closeButton"
                                        value="checked">
                                    <label class="form-check-label" for="closeButton">Close Button</label>
                                </div>

                                <div class="form-check mb-2">
                                    <input type="checkbox" class="form-check-input input-mini" id="addBehaviorOnToastClick"
                                        value="checked">
                                    <label class="form-check-label" for="addBehaviorOnToastClick">Add behavior on toast
                                        click</label>
                                </div>

                                <div class="form-check mb-2">
                                    <input type="checkbox" class="form-check-input input-mini" id="debugInfo"
                                        value="checked">
                                    <label class="form-check-label" for="debugInfo">Debug</label>
                                </div>

                                <div class="form-check mb-2">
                                    <input type="checkbox" class="form-check-input input-mini" id="progressBar"
                                        value="checked">
                                    <label class="form-check-label" for="progressBar">Progress Bar</label>
                                </div>

                                <div class="form-check mb-2">
                                    <input type="checkbox" class="form-check-input input-mini" id="preventDuplicates"
                                        value="checked">
                                    <label class="form-check-label" for="preventDuplicates">Prevent Duplicates</label>
                                </div>

                                <div class="form-check mb-2">
                                    <input type="checkbox" class="form-check-input input-mini" id="addClear"
                                        value="checked">
                                    <label class="form-check-label" for="addClear">Add button to force clearing a toast,
                                        ignoring focus</label>
                                </div>

                                <div class="form-check mb-2">
                                    <input type="checkbox" class="form-check-input input-mini" id="newestOnTop"
                                        value="checked">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <div class="button-items">
                                ...
                                <button type="button" class="btn btn-danger" id="clearlasttoast">Clear Last
                                    Toast</button>
                            </div>
                        </div>
                    </div>
