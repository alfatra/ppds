...
@endpush
@section('content')
    <x-breadcrumb pagetitle="Ecommerce" title="Products" />
        ...
        <div class="col-xl-3 col-lg-4">
            <div class="card">
                    ...
                    <div class="accordion ecommerce" id="accordionExample">
                        ...
                        <div class="accordion-item mb-3">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                ...
                                <div class="accordion-body">
                                    <ul class="list-unstyled categories-list mb-0">
                                        <li><a href="#"><i class="mdi mdi-circle-medium me-1"></i> Gym equipment</a>
                                        </li>
                                        <li><a href="#"><i class="mdi mdi-circle-medium me-1"></i> Yoga mat</a></li>
                                        <li><a href="#"><i class="mdi mdi-circle-medium me-1"></i> Dumbbells</a>
                                        </li>
                ...
                <div class="custom-accordion">
                    <div class="card-body border-top">
                        <div>
                            <h5 class="font-size-14 mb-0"><a href="#collapseExample1" class="text-reset d-block"
                    ...
                    <div class="card-body border-top">
                        <div>
                            <h5 class="font-size-14 mb-0"><a href="#collapseExample2" class="text-reset d-block"
                                    data-bs-toggle="collapse">Size <i
                                        class="mdi mdi-minus float-end accor-plus-icon"></i></a></h5>
                            ...
                            <div class="collapse show" id="collapseExample2">
                                ...
                                <div class="mt-4">
                                    <div class="form-check mt-2">
                                        <input type="radio" id="productsizeRadio1" name="productsizeRadio"
                                            class="form-check-input">
                                        <label class="form-check-label" for="productsizeRadio1">X-Large</label>
                                    </div>
                                    <div class="form-check mt-2">
                                        <input type="radio" id="productsizeRadio2" name="productsizeRadio"
                                            class="form-check-input">
                                        <label class="form-check-label" for="productsizeRadio2">Large</label>
                                    </div>
                                    <div class="form-check mt-2">
                                        <input type="radio" id="productsizeRadio3" name="productsizeRadio"
                                            class="form-check-input">
                                        <label class="form-check-label" for="productsizeRadio3">Medium</label>
                                    </div>
                                    <div class="form-check mt-2">
                                        <input type="radio" id="productsizeRadio4" name="productsizeRadio"
                                            class="form-check-input">
                    ...
                    <div class="card-body border-top">
                        <div>
                            <h5 class="font-size-14 mb-0"><a href="#collapseExample3"
                                    class="collapsed text-reset d-block" data-bs-toggle="collapse">Customer Rating <i
                                        class="mdi mdi-minus float-end accor-plus-icon"></i></a></h5>
                ...
                <div class="card-body">
                    <div>
                        ...
                        <ul class="list-inline my-3 ecommerce-sortby-list">
                            <li class="list-inline-item"><span class="fw-medium font-family-secondary">Sort by:</span>
                            </li>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="product-box">
                                    <div class="product-img">
                                        ...
                                        <img src="{{ URL::asset('build/images/product/img-1.png') }}" alt="img-1"
                                            class="img-fluid mx-auto d-block">
                                    </div>

                                    <div class="text-center">
                                        <p class="font-size-12 mb-1">Blue color, T-shirt</p>
                                        <h5 class="font-size-15"><a href="#" class="text-reset">Full sleeve
                                                T-shirt</a></h5>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="product-box">
                                    <div class="product-img">
                                        ...
                                        <img src="{{ URL::asset('build/images/product/img-2.png') }}" alt="img-2"
                                            class="img-fluid mx-auto d-block">
                                    </div>

                                    <div class="text-center">
                                        <p class="font-size-12 mb-1">Half sleeve, T-shirt</p>
                                        <h5 class="font-size-15"><a href="#" class="text-reset">Half sleeve T-shirt
                                            </a></h5>

                                        <h5 class="mt-3 mb-0"><span class="text-muted me-2"><del>$240</del></span>$225
                                        </h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-sm-6">
                                <div class="product-box">
                                    <div class="product-img">
                                        ...
                                        <img src="{{ URL::asset('build/images/product/img-3.png') }}" alt="img-3"
                                            class="img-fluid mx-auto d-block">
                                    </div>

                                    <div class="text-center">
                                        <p class="font-size-12 mb-1">Green color, Hoodie</p>
                                        <h5 class="font-size-15"><a href="#" class="text-reset">Hoodie (Green)</a>
                                        </h5>

                                        <h5 class="mt-3 mb-0"><span class="text-muted me-2"><del>$290</del></span>$275
                                        </h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-sm-6">
                                <div class="product-box">
                                    <div class="product-img">
                                        ...
                                        <img src="{{ URL::asset('build/images/product/img-4.png') }}" alt="img-4"
                                            class="img-fluid mx-auto d-block">
                                    </div>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="product-box">
                                    <div class="product-img">
                                        ...
                                        <img src="{{ URL::asset('build/images/product/img-5.png') }}" alt="img-5"
                                            class="img-fluid mx-auto d-block">
                                    </div>
                            ...
                            <div class="col-xl-4 col-sm-6">
                                <div class="product-box">
                                    <div class="product-img">
                                        ...
                                        <img src="{{ URL::asset('build/images/product/img-6.png') }}" alt="img-6"
                                            class="img-fluid mx-auto d-block">
