...
@endsection
@section('content')
    <x-breadcrumb pagetitle="Email" title="Inbox" />
        ...
        <div class="col-12">
            ...
            <div class="email-leftbar card">
                ...
                <div class="mt-2">
                    ...
                    <a href="#" class="d-flex">
                        <img class="d-flex me-3 rounded-circle" src="{{ URL::asset('build/images/users/avatar-4.jpg') }}"
                            alt="Generic placeholder image" height="36">
                        <div class="flex-1 chat-user-box overflow-hidden">
                    ...
                    <a href="#" class="d-flex">
                        <img class="d-flex me-3 rounded-circle" src="{{ URL::asset('build/images/users/avatar-6.jpg') }}"
                            alt="Generic placeholder image" height="36">
                        <div class="flex-1 chat-user-box overflow-hidden">
