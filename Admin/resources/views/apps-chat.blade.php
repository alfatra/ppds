...
@endsection
@section('content')
    <x-breadcrumb pagetitle="Nazox" title="Chat" />
            ...
            <div class="p-3 border-bottom">
                <div class="d-flex">
                    <div class="align-self-center me-3">
                        <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="avatar-xs rounded-circle" alt="avatar-2">
                    </div>
                    <div class="flex-1">
                        ...
                        <li>
                            <div class="conversation-list">
                                ...
                                <div class="ctext-wrap">
                                    ...
                                    <p class="chat-time mb-0"><i class="mdi mdi-clock-outline align-middle me-1"></i>
                                        12:09</p>
                                </div>
