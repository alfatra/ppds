...
@push('css')
    <!-- roundslider css -->
    <link rel="stylesheet" href="{{ URL::asset('build/libs/round-slider/roundslider.min.css') }}">
@endpush
@section('content')
    <x-breadcrumb pagetitle="UI Elements" title="Round slider" />
...
@push('script')
    <!-- roundslider js -->
    <script src="{{ URL::asset('build/libs/round-slider/roundslider.min.js') }}"></script>

    <!-- roundslider init -->
    <script src="{{ URL::asset('build/js/pages/roundslider.init.js') }}"></script>
