...
@endsection
@section('content')
    <x-breadcrumb pagetitle="UI Elements" title="Images" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mt-4 mt-md-0">
                                <img class="rounded-circle avatar-xl" alt="200x200" src="{{ URL::asset('build/images/users/avatar-4.jpg') }}"
                                    data-holder-rendered="true">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-lg-4">
                                    <div>
                                        <img src="{{ URL::asset('build/images/users/avatar-3.jpg') }}" alt="avatar-3"
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        <img src="{{ URL::asset('build/images/users/avatar-4.jpg') }}" alt="avatar-4"
                                ...
                                <div class="col-lg-4">
                                    <div>
                                        <img src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" alt="avatar-5"
