...
@endsection
@section('content')
    <x-breadcrumb pagetitle="UI Elements" title="Tabs & Accordions" />
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p>
                        <a class="btn btn-primary mt-1 me-1" data-bs-toggle="collapse" href="#collapseExample"
                ...
                <div class="card-body">
                    ...
                    <div id="accordion" class="custom-accordion">
                        <div class="card mb-1 shadow-none">
                            <a href="#collapseOne" class="text-reset" data-bs-toggle="collapse" aria-expanded="true"
