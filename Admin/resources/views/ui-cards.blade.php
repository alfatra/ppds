...
@endsection
@section('content')
    <x-breadcrumb pagetitle="UI Elements" title="Cards" />
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card bg-dark text-white">
                <div class="card-body">
                    <h5 class="mb-4 text-white"><i class="mdi mdi-alert-circle-outline me-3"></i>Dark Card</h5>
                    <p class="card-text opacity-75">Some quick example text to build on the card title and make up the bulk
            ...
            <div class="row" data-masonry='{"percentPosition": true }'>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card p-3 text-end">
                        <blockquote class="card-blockquote text-right  mb-0">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="card bg-primary text-white text-center p-3">
                        <blockquote class="card-blockquote font-size-14 mb-0">
                            ...
                            <footer class="blockquote-footer text-white font-size-12 m-0">
                                Someone famous in <cite title="Source Title">Source Title</cite>
                            </footer>
                        </blockquote>
                    </div>
