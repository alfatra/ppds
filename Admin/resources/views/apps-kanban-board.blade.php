...
@endpush
@section('content')
    <x-breadcrumb pagetitle="Nazox" title="Kanban Board" />

    <div class="row mb-2">
        <div class="col-lg-6">
            <div class="d-flex">
                <div class="me-3">
                    <img src="{{ URL::asset('build/images/logo-sm-light.png') }}" alt="logo-sm-light" class="avatar-xs">
                </div>
                <div class="flex-1">
                ...
                <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                        <a href="javascript: void(0);" class="d-inline-block">
                            <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="rounded-circle avatar-xs" alt="avatar-2">
                        </a>
                    </li>
                    <li class="list-inline-item">
                        <a href="javascript: void(0);" class="d-inline-block">
                    ...
                    <li class="list-inline-item">
                        <a href="javascript: void(0);" class="d-inline-block">
                            <img src="{{ URL::asset('build/images/users/avatar-4.jpg') }}" class="rounded-circle avatar-xs" alt="avatar-4">
                        </a>
                    </li>
                    ...
                    <div id="todo-task" class="task-list">
                        <div class="card task-box">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-16"><a href="javascript: void(0);" class="text-reset">Admin layout
                                            design</a></h5>
                                ...
                                <div class="d-inline-flex team mb-0">
                                    ...
                                    <div class="team-member">
                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                            <img src="{{ URL::asset('build/images/users/avatar-2.jpg') }}" class="rounded-circle avatar-xs"
                                                alt="avatar-2">
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="card task-box">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-16"><a href="javascript: void(0);" class="text-reset">Chat app
                                            page</a></h5>
                        ...
                        <div class="card task-box">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-16"><a href="javascript: void(0);" class="text-reset">Ecommerce
                                            App pages</a></h5>
                                ...
                                <div class="d-inline-flex team mb-0">
                                    ...
                                    <div class="team-member">
                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                            <img src="{{ URL::asset('build/images/users/avatar-5.jpg') }}" class="rounded-circle avatar-xs"
                                                alt="avatar-5">
                                        </a>
                                    </div>
                                    <div class="team-member">
                                    ...
                                    <div class="team-member">
                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                            <img src="{{ URL::asset('build/images/users/avatar-6.jpg') }}" class="rounded-circle avatar-xs"
                                                alt="avatar-6">
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div id="inprogress-task" class="task-list">
                        <div class="card task-box">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-16"><a href="javascript: void(0);" class="text-reset">Dashboard
                                            UI</a></h5>
                                ...
                                <div class="d-inline-flex team mb-0">
                                    ...
                                    <div class="team-member">
                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                            <img src="{{ URL::asset('build/images/users/avatar-7.jpg') }}" class="rounded-circle avatar-xs"
                                                alt="avatar-7">
                                        </a>
                                    </div>
                                    ...
                                    <div class="team-member">
                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                            <img src="{{ URL::asset('build/images/users/avatar-8.jpg') }}" class="rounded-circle avatar-xs"
                                                alt="avatar-8">
                                        </a>
                                    </div>
                        ...
                        <div class="card task-box">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-16"><a href="javascript: void(0);"
                                            class="text-reset">Authentication pages</a></h5>
                        ...
                        <div class="card task-box">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-16"><a href="javascript: void(0);" class="text-reset">UI
                                            Elements pages</a></h5>
                    ...
                    <div id="complete-task" class="task-list">
                        <div class="card task-box">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-16"><a href="javascript: void(0);" class="text-reset">Brand logo
                                            design</a></h5>
                        ...
                        <div class="card task-box">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-16"><a href="javascript: void(0);" class="text-reset">Email
                                            pages</a></h5>
                        ...
                        <div class="card task-box">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <h5 class="font-size-16"><a href="javascript: void(0);" class="text-reset">Forms
                                            pages</a></h5>
                                ...
                                <div class="d-inline-flex team mb-0">
                                    ...
                                    <div class="team-member">
                                        <a href="javascript: void(0);" class="team-member d-inline-block">
                                            <img src="{{ URL::asset('build/images/users/avatar-1.jpg') }}" class="rounded-circle avatar-xs"
                                                alt="avatar-1">
                                        </a>
                                    </div>
                                </div>
