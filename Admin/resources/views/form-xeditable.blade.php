...
@push('css')
    <!-- Plugins css -->
    <link href="{{ URL::asset('build/libs/bootstrap-editable/css/bootstrap-editable.css') }}" rel="stylesheet" type="text/css" />
    @section('content')
        <x-breadcrumb pagetitle="Forms" title="Form X-editable" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" id="inline-status" data-type="select" data-pk="1"
                                                data-value="0" data-source="/status" data-title="Select status">Active</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Combodate</td>
                                        <td>
                                            <a href="#" id="inline-dob" data-type="combodate" data-value="2015-04-15"
    ...
    @push('script')
        ...
        <script src="{{ URL::asset('build/libs/bootstrap-editable/js/index.js') }}"></script>

        <!-- Init js-->
        <script src="{{ URL::asset('build/js/pages/form-xeditable.init.js') }}"></script>
