...
@endsection
@section('content')
    <x-breadcrumb pagetitle="UI Elements" title="Typography" />
        ...
        <div class="col-xl-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="mb-3">h3. Bootstrap heading <small class="text-muted">Semibold 1.575rem (25.2px)</small>
                    </h3>
                    <h4 class="mb-3">h4. Bootstrap heading <small class="text-muted">Semibold 1.35rem (21.6px)</small>
                    </h4>
                        ...
                        <div class="col-xl-6">
                            <div>
                                <blockquote class="blockquote font-size-16 mb-0">
                                    ...
                                    <footer class="blockquote-footer m-0">Someone famous in <cite
