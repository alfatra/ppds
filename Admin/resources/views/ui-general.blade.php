...
@endsection
@section('content')
    <x-breadcrumb pagetitle="UI Elements" title="General" />
                        ...
                        <div class="col-lg-6">
                            <div>
                                ...
                                <div class="mt-1">
                                    ...
                                    <span class="badge bg-dark-subtle text-reset">Dark</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="mt-4 mt-lg-0">
                                ...
                                <div class="mt-1">
                                    ...
                                    <span class="badge rounded-pill bg-dark-subtle text-reset">Dark</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="button-items">
                        ...
                        <button type="button" class="btn btn-light waves-effect" data-bs-toggle="popover"
