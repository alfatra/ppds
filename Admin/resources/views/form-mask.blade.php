...
@endsection
@section('content')
    <x-breadcrumb pagetitle="Forms" title="Form Mask" />
                            ...
                            <div class="col-lg-6">
                                <div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input id="input-datetime" class="form-control input-mask" data-inputmask="'alias': 'datetime'" data-inputmask-inputformat="dd-mm-yyyy HH:MM:ss">e.g "yyyy-mm-dd'T'HH:MM:ss"</span>
                                    </div>
                                    <div class="mb-0">
