...
@endsection
@section('content')
    <x-breadcrumb pagetitle="Ecommerce" title="Product Detail" />
                        ...
                        <div class="col-xl-7">
                            <div class="mt-4 mt-xl-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div>
                                            <h5 class="font-size-14"><i class="mdi mdi-location"></i> Delivery location
                                            </h5>
                                            ...
                                            <ul class="list-unstyled product-desc-list">
                                                <li><i class="mdi mdi-circle-medium me-1 align-middle"></i> Full Sleeve
                                                </li>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <ul class="list-unstyled product-desc-list">
                                            <li><i class="mdi mdi-sync text-primary me-1 align-middle font-size-16"></i> 10
                                                Days Replacement</li>
                                            <li><i
                            ...
                            <div class="tab-content border border-top-0 p-4">
                                <div class="tab-pane fade" id="desc" role="tabpanel">
                                    <div>
                                        ...
                                        <p>To achieve this, it would be necessary to have uniform grammar, pronunciation and
                                            more common several languages coalesce, the grammar of the resulting.</p>
                                        <p>It will be as simple as occidental in fact.</p>

                                        <div>
                                            <p class="mb-2"><i class="mdi mdi-circle-medium me-1 align-middle"></i> If
                                                several languages coalesce</p>
                                            <p class="mb-2"><i class="mdi mdi-circle-medium me-1 align-middle"></i> To
                                                an English person, it will seem like simplified</p>
                                            <p class="mb-0"><i class="mdi mdi-circle-medium me-1 align-middle"></i>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="border p-4 rounded">
                            <div class="d-flex border-bottom pb-3">
                                <div class="flex-1">
                                    <p class="text-muted mb-2">To an English person, it will seem like simplified English,
                                    ...
                                    <ul class="list-inline product-review-link mb-0">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="#"><i class="mdi mdi-message-text align-middle me-1"></i>
                                                Comment</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="d-flex border-bottom py-3">
                                <div class="flex-1">
                                    <p class="text-muted mb-2">Everyone realizes why a new common language would be
                                        desirable</p>
                            ...
                            <div class="d-flex py-3">
                                <div class="flex-1">
                                    <p class="text-muted mb-2">If several languages coalesce, the grammar of the resulting
                                    </p>
