...
@endpush
@section('content')
    <x-breadcrumb pagetitle="Ecommerce" title="Customers" />
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <a href="javascript:void(0);" class="btn btn-success mb-2"><i class="mdi mdi-plus me-2"></i> Add
                            Customer</a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td id="tooltip-container13">
                                        <a href="javascript:void(0);" class="me-3 text-primary"
                                            data-bs-container="#tooltip-container13" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Edit"><i
                                                class="mdi mdi-pencil font-size-18"></i></a>
                                        <a href="javascript:void(0);" class="text-danger"
                                            data-bs-container="#tooltip-container13" data-bs-toggle="tooltip"
...
@push('script')
    ...
    <script src="{{ URL::asset('build/js/pages/ecommerce-customer-datatables.init.js') }}"></script>
