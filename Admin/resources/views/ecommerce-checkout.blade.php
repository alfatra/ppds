...
@endpush
@section('content')
    <x-breadcrumb pagetitle="Ecommerce" title="Checkout" />
                                        ...
                                        <div class="col-lg-4 col-sm-6">
                                            <div>
                                                <label class="form-label card-radio-label mb-3">
                                                    ...
                                                    <span class="card-radio">
                                                        <i
                                                            class="far fa-money-bill-alt font-size-24 align-middle me-2"></i>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-sm-6">
                                                    <div class="mb-3 mb-lg-0">
                                                        <label class="form-label" for="cardnumberInput">Card
                                                            Number</label>
                                                ...
                                                <div class="col-lg-4 col-sm-6">
                                                    <div class="mb-3 mb-lg-0">
                                                        <label class="form-label" for="expirydateInput">Expiry
                                                            date</label>
                                    ...
                                    <td colspan="3">
                                        <div class="bg-primary-subtle  p-3 rounded">
                                            <h5 class="font-size-14 text-primary mb-0"><i
                                                    class="fas fa-shipping-fast me-2"></i> Shipping <span
                                                    class="float-end">Free</span></h5>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
