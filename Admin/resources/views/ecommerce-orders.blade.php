...
@endpush
@section('content')
    <x-breadcrumb pagetitle="Ecommerce" title="Orders" />
                        ...
                        <table class="table table-centered datatable dt-responsive nowrap"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:void(0);" class="me-3 text-primary" data-bs-toggle="tooltip"
                                ...
                                <tr>
                                    ...
                                    <td><a href="javascript: void(0);" class="text-reset fw-bold">#NZ15632</a> </td>
                                    <td>
                                        27 Mar, 2020
                                    </td>
...
@push('script')
    ...
    <script src="{{ URL::asset('build/js/pages/ecommerce-order-datatables.init.js') }}"></script>
